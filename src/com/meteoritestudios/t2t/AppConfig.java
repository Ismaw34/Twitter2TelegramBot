...
public final class AppConfig {
	...
	public static final String TWITTER_NICK = ""; // EX: Good =
															// "Twitter", Bad =
															// "@Twitter"
	public static final int TWITTER_RETWEET = 0, TWITTER_UNRETWEET = 1,
			TWITTER_LIKE = 2, TWITTER_UNLIKE = 3;
	public static final String[] TWITTER_ICONS = new String[] { "🔁", "🔂",
			"❤️", "💔" }; // Ret | UnRet | Like | Unlike
	public static final String[] TWITTER_IGNORE = new String[] {};
}
